...
class Request
{
	...
	public function getMessageId($message_id)
	{
	...
	public function sendReply($text)
	{
		$this->apiRequest("sendMessage", array('chat_id' => $this->chat_id,"reply_to_message_id" => $this->message_id, "text" =>  $text));
	}
